        ...
        <div className="px-6 flex items-center justify-between space-x-4 2xl:container">
            ...
            <div className="flex space-x-4">
                ...
                <div aria-label="notification" className="w-10 h-10 rounded-xl border bg-gray-100 focus:bg-gray-100 active:bg-gray-200">
                    ...
                    <img src="https://tailus.io/sources/blocks/stats-cards/preview/images/second_user.webp" alt="" className="h-auto w-auto m-auto rounded" />

                    <div className="mt-2 text-center">
                        <h5 className="hidden mt-2 text-sm font-semibold text-gray-600 lg:block">Imaculate</h5>
