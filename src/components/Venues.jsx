...
const Venues = () => (
  <>
    <div className="ml-auto mb-6 lg:w-[75%] xl:w-[80%] 2xl:w-[85%] bg-orange-50">
    <div className="sticky z-10 top-0 h-16 border-b bg-white lg:py-2.5">
        <div className="px-6 flex items-center justify-between space-x-4 2xl:container">
            <h5 hidden className="text-2xl text-gray-600 font-medium lg:block">Venue Spot</h5>
            ...
            <div className="flex space-x-4">
                ...
                <div hidden className="md:block">
                    <div className="relative flex items-center text-gray-400 focus-within:text-cyan-400">
                        ...
                        <input type="search" name="leadingIcon" id="leadingIcon" placeholder="Search venues" className="w-full pl-14 pr-4 py-2.5 rounded-xl text-sm text-gray-600 outline-none border border-gray-300 focus:border-cyan-300 transition" />
                    </div>
                </div>
                {/* <!--/search bar --> */}
                ...
                <div aria-label="notification" className="w-10 h-10 rounded-xl border bg-gray-100 focus:bg-gray-100 active:bg-gray-200">
                    ...
                    <div className="mt-2 text-center">
                        <h5 className="hidden mt-2 text-sm font-semibold text-gray-600 lg:block">Jacob Ndwati</h5>
